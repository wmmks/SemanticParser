...
merged=Merge([word_model,pos_model,dep_model],mode='concat')
...
final_model.fit([x_train,p_train,d_train],y_train,batch_size=batch_size,validation_split=0.1,epochs=500)
...
score, acc = final_model.evaluate([x_test,p_test,d_test], y_test,batch_size=batch_size)
