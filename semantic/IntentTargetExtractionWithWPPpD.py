...
#final_model.fit([x_train,p_train,pp_train,d_train],y_train,batch_size=batch_size,validation_split=0.1,epochs=500)
		  

#final_model.save_weights('model/LSTMwithAll.mod')

final_model.load_weights('model/LSTMwithAll.mod')
