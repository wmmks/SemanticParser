...
pos_model.add(Embedding(int(max_dependency_features),128,mask_zero=True))
...
#final_model.fit([x_train,d_train],y_train,batch_size=batch_size,validation_split=0.1,epochs=500)
...
score, acc = final_model.evaluate([x_test,d_test], y_test,batch_size=batch_size)
